/*************************************************************************************
  ...
  0 - 300     Baud Serial Terminal 
  1 - 1200    Baud Serial Terminal 
  2 - 9600    Baud Serial Terminal (Default)
  3 - 38400   Baud Serial Terminal
  4 - 115200  Baud Serial Terminal (Low Quality)
  5 - 250000  Baud Serial Terminal
  6 - 500000  Baud Serial Terminal
  7 - 1000000 Baud Serial Terminal (Low Quality)
  8 - 1000000 Baud Serial Terminal (Low Quality)
...
void interpretVT52EscapeSequence (const char currentChar)
{
  ...
  else if (currentChar == 'Z')
  {
    ...
    CPLD_TAKE; LED2_ON; uart_transmit(0x06); return;
  }
  else if (currentChar == '%') {
    VGATONIC_MODE = 8; uart_transmit('|'); return;
  }
  else if (currentChar == 'r') {
    CPLD_GIVE; LED2_OFF; uart_transmit(0x06); return;
  }
