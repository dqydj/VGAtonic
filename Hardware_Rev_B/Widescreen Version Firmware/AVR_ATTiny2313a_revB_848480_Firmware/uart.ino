...
void inline uart_speed_300() {
  UBRRH = (uint8_t)(BAUD_PRESCALE(300) >> 8); 
  UBRRL = (uint8_t)(BAUD_PRESCALE(300)); 
}

void inline uart_speed_2400() {
  UBRRH = (uint8_t)(BAUD_PRESCALE(2400) >> 8); 
  UBRRL = (uint8_t)(BAUD_PRESCALE(2400)); 
}
...
void inline uart_speed_57600() {
  UBRRH = (uint8_t)(BAUD_PRESCALE_U2X(57600) >> 8); 
  UBRRL = (uint8_t)(BAUD_PRESCALE_U2X(57600)); 
}

void inline uart_speed_115200() {
  UBRRH = (uint8_t)(BAUD_PRESCALE(115200) >> 8); 
  UBRRL = (uint8_t)(BAUD_PRESCALE(115200)); 
}
