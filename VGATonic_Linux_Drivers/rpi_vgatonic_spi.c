/*
	...
	I only tested this on a Raspberry Pi 2.  This will likely be different on whatever version you have - 
	no warranties, implied or otherwise, of course!

	Luckily, the changes will be short for most boards - but you're on your own.
